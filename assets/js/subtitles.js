...
const UI_STRINGS = {
  hy: {
    ...
    formTitle: 'Թողեք ձեր էլ. փոստը և առաջինը իմացեք բացման մասին։',
    subtitle: 'Մեկ նամակ բացման օրը՝ ուրիշ ոչինչ։',
    emailLabel: 'Էլ. փոստ',
  ...
  en: {
    ...
    formTitle: 'Leave your email and be the first to know when we open.',
    subtitle: 'One email when we open — nothing else.',
    emailLabel: 'Email',
    emailPlaceholder: 'you@example.com',
    submit: 'Notify me',
    sending: 'Sending…',
  ...
  ru: {
    ...
    formTitle: 'Оставьте e-mail и узнайте об открытии первыми.',
    subtitle: 'Одно письмо в день открытия — больше ничего.',
    emailLabel: 'E-mail',
    emailPlaceholder: 'you@example.com',
    submit: 'Сообщить мне',
    sending: 'Отправка…',
